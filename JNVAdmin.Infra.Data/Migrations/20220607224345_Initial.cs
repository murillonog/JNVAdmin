...
namespace JNVAdmin.Infra.Data.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvarageAge = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    SpentValue = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ReceivedValue = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    FullValue = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_Snacks_SnackId",
                        column: x => x.SnackId,
